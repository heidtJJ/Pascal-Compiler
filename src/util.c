...
/*
    Had trouble getting std itoa to work. Made my own.
*/
...
/*
    Returns 1 if the opval of the root is OR.
    0 otherwise.
*/
...
/*
    Returns 1 if the opval of the root is AND.
    0 otherwise.
*/
