...
typedef struct scope_s {
    ...
    // Offsets on the stack frame for the temporary registers.
    // Need for case 4 in gencode algorithm. 
    int tempRegisterOffsets[NUM_TEMP_REGISTERS];
